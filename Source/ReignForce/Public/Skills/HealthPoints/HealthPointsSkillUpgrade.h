...
#include "HealthPointsSkillUpgrade.generated.h"
...
class REIGNFORCE_API UHealthPointsSkillUpgrade : public UShooterSkillUpgrade
{
	GENERATED_BODY()

public:
	UHealthPointsSkillUpgrade(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
