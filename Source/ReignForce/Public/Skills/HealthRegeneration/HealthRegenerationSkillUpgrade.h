...
#include "HealthRegenerationSkillUpgrade.generated.h"
...
class REIGNFORCE_API UHealthRegenerationSkillUpgrade : public UShooterSkillUpgrade
{
	GENERATED_BODY()

public:
	UHealthRegenerationSkillUpgrade(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
